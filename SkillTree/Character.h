...
struct CharacterStats {
    ...
    // Battle Skill Points (like HSR)
    int battleSkillPoints;
    int maxBattleSkillPoints;
    ...
    CharacterStats() {
        ...
        // Battle skill points - start dengan 3 per battle
        maxBattleSkillPoints = 3;
        battleSkillPoints = maxBattleSkillPoints;
    }
};
